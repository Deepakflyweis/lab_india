...
import '../subscription_page3/subscriptions_page3.dart';

class GoldenNext extends StatelessWidget {
  const GoldenNext({Key? key}) : super(key: key);
          ...
          child: Column(
            children: [
              ...
              RecButton(
                  ...
                  onTap: () {
                    Navigator.push(context, MaterialPageRoute(builder: (context)=> GoldenPay()));
                    //GoldenPay
