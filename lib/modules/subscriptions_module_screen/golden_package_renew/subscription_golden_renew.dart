...
import '../subscription_page2/golden_subscription_page2.dart';

class GoldenRenew extends StatelessWidget {
  const GoldenRenew({Key? key}) : super(key: key);
            ...
            children: [
              ...
              Align(
                ...
                child: Padding(
                  ...
                  child: Text(AppTexts.Gold+" " + AppTexts.Package,
                    ...
                    children: [
                      Column(
                        ...
                        children: [
                          ...
                          Text(AppTexts.Day+""+ AppTexts.Reamaining,
                            style: TextStyle(
                              fontSize: 18,
                              color: AppColors.grey400,
                            ),
              ...
              RecButton(
                title: AppTexts.RENEW,
                  //title: AppTexts.getStarted,
                  onTap: () {
                    //Navigator.pushNamed(context, goldenRenewScreenRoute);
                    Navigator.push(context, MaterialPageRoute(builder: (context)=> GoldenNext()));
                  //GoldenNext
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Center(child: Text(AppTexts.UNMANAGE)),
                    ),
                    Container(
                      height: 6.h,
                      width: 45.w,
                      ...
                      child: Center(child: Text(AppTexts.UNSUBSCRIBE)),
                    ),
                  ],
                ),
              ),
